 ...
 */
bool CHealthBar::Init(glm::vec3 pos, glm::vec4 color)
{
 ...
 */
void CHealthBar::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CHealthBar::SetView(glm::mat4 view)
{
 ...
 */
void CHealthBar::SetProjection(glm::mat4 projection)
{
...
/**
 @brief PreRender Set up the OpenGL display environment before rendering
 */
void CHealthBar::PreRender(void)
{
 ...
 */
void CHealthBar::PostRender(void)
{
	// Disable blending
	glDisable(GL_BLEND);
}

bool CHealthBar::GetHealthBarState()
{
	return healthBar;
}
