 ...
 */
CFreezeMovement::CFreezeMovement(void)
	: cGroundMap(NULL)
{
 ...
 */
CFreezeMovement::CFreezeMovement(const glm::vec3 vec3Position,
 ...
 */
bool CFreezeMovement::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CFreezeMovement::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::FREEZE_MOVEMENT);
	...
	std::string file_path = "OBJ/IceCube.obj";
	...
	iTextureID = LoadTexture("Image/Ice_Cube.tga");
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/Ice_Cube.tga" << endl;
		return false;
	}
 ...
 */
void CFreezeMovement::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CFreezeMovement::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CFreezeMovement::SetProjection(glm::mat4 projection)
{
...
*/
void CFreezeMovement::Update(const double dElapsedTime)
{
...
*/
void CFreezeMovement::ActivateCollider(Shader* cLineShader)
{
...
*/
void CFreezeMovement::PreRender(void)
{
	// Draw this as last
...
*/
void CFreezeMovement::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CFreezeMovement::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CFreezeMovement::PostRender(void)
{
