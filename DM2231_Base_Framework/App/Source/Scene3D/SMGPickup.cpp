 ...
 */
CSMGPickup::CSMGPickup(const glm::vec3 vec3Position,
 ...
 */
bool CSMGPickup::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CSMGPickup::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::SMG_PICKUP);
	...
	std::string file_path = "OBJ/SMG.obj";
 ...
 */
void CSMGPickup::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CSMGPickup::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CSMGPickup::SetProjection(glm::mat4 projection)
{
...
*/
void CSMGPickup::Update(const double dElapsedTime)
{
...
*/
void CSMGPickup::ActivateCollider(Shader* cLineShader)
{
...
*/
void CSMGPickup::PreRender(void)
{
	// Draw this as last
...
*/
void CSMGPickup::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CSMGPickup::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CSMGPickup::PostRender(void)
{
