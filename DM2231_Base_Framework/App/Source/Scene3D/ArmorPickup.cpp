 ...
 */
CArmorPickup::CArmorPickup(void)
	: cGroundMap(NULL)
	, cPlayer3D(NULL)
	, iAddArmor(30)
{
 ...
 */
CArmorPickup::CArmorPickup(const glm::vec3 vec3Position,
 ...
 */
bool CArmorPickup::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CArmorPickup::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::ARMOR_PICKUP);
	...
	std::string file_path = "OBJ/Armor.obj";
 ...
 */
void CArmorPickup::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CArmorPickup::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CArmorPickup::SetProjection(glm::mat4 projection)
{
...
*/
void CArmorPickup::Update(const double dElapsedTime)
{
...
*/
void CArmorPickup::ActivateCollider(Shader* cLineShader)
{
...
*/
void CArmorPickup::PreRender(void)
{
	// Draw this as last
...
*/
void CArmorPickup::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CArmorPickup::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CArmorPickup::PostRender(void)
{
