 ...
 */
CStructureTower::CStructureTower(	const glm::vec3 vec3Position,
 ...
 */
bool CStructureTower::Init(void)
{
	...
	iTextureID = LoadTexture("Image/tower.tga");
	if (iTextureID == 0)
	{
 ...
 */
void CStructureTower::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CStructureTower::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CStructureTower::SetProjection(glm::mat4 projection)
{
...
*/
void CStructureTower::ActivateCollider(Shader* cLineShader)
{
...
*/
void CStructureTower::PreRender(void)
{
	// Draw this as last
...
*/
void CStructureTower::Render(void)
{
...
*/
void CStructureTower::PostRender(void)
{
