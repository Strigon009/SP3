...
int CEnemy3D2::GetEnemyHealth()
{
	return enemyHealth;
}

void CEnemy3D2::SetEnemyHealth(int x)
{
	enemyHealth = x;
}

int CEnemy3D2::GetEnemyDamage()
{
	return enemyDamage;
}

void CEnemy3D2::SetEnemyDamage(int t)
{
	enemyDamage = t;
}

void CEnemy3D2::SetEnemyExp(float exp)
{
	enemyExp = exp;
}

float CEnemy3D2::GetEnemyExp()
{
	return enemyExp;
}
