 ...
 */
CMinigunPickup::CMinigunPickup(void)
	: cGroundMap(NULL)
	, cPlayer3D(NULL)
{
 ...
 */
CMinigunPickup::CMinigunPickup(const glm::vec3 vec3Position,
 ...
 */
bool CMinigunPickup::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CMinigunPickup::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::MINIGUN_PICKUP);
	...
	std::string file_path = "OBJ/Minigun.obj";
	...
	iTextureID = LoadTexture("Image/Armor.tga");
	if (iTextureID == 0)
	{
 ...
 */
void CMinigunPickup::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CMinigunPickup::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CMinigunPickup::SetProjection(glm::mat4 projection)
{
...
*/
void CMinigunPickup::Update(const double dElapsedTime)
{
...
*/
void CMinigunPickup::ActivateCollider(Shader* cLineShader)
{
...
*/
void CMinigunPickup::PreRender(void)
{
	// Draw this as last
...
*/
void CMinigunPickup::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CMinigunPickup::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CMinigunPickup::PostRender(void)
{
