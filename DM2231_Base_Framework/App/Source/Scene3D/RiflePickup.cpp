 ...
 */
CRiflePickup::CRiflePickup(void)
	: cGroundMap(NULL)
	, cPlayer3D(NULL)
{
 ...
 */
CRiflePickup::CRiflePickup(const glm::vec3 vec3Position,
 ...
 */
bool CRiflePickup::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CRiflePickup::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::RIFLE_PICKUP);
	...
	std::string file_path = "OBJ/Rifle.obj";
 ...
 */
void CRiflePickup::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CRiflePickup::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CRiflePickup::SetProjection(glm::mat4 projection)
{
...
*/
void CRiflePickup::Update(const double dElapsedTime)
{
...
*/
void CRiflePickup::ActivateCollider(Shader* cLineShader)
{
...
*/
void CRiflePickup::PreRender(void)
{
	// Draw this as last
...
*/
void CRiflePickup::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CRiflePickup::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CRiflePickup::PostRender(void)
{
