 ...
 */
CAmmoPickup::CAmmoPickup(const glm::vec3 vec3Position,
 ...
 */
bool CAmmoPickup::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CAmmoPickup::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::AMMO_PICKUP);
	...
	std::string file_path = "OBJ/AmmoCrate.obj";
	...
	iTextureID = LoadTexture("Image/AmmoCrate.tga");
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/AmmoCrate.tga" << endl; // Change file
		return false;
	}
 ...
 */
void CAmmoPickup::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CAmmoPickup::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CAmmoPickup::SetProjection(glm::mat4 projection)
{
...
*/
void CAmmoPickup::Update(const double dElapsedTime)
{
...
*/
void CAmmoPickup::ActivateCollider(Shader* cLineShader)
{
...
*/
void CAmmoPickup::PreRender(void)
{
	// Draw this as last
...
*/
void CAmmoPickup::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CAmmoPickup::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CAmmoPickup::PostRender(void)
{
	glDepthFunc(GL_LESS); // set depth function back to default
}

void CAmmoPickup::SetAddAmmo(const int iAddAmmo)
{
	this->iAddAmmo = iAddAmmo;
}

int CAmmoPickup::GetAddAmmo(void) const
{
	return iAddAmmo;
}