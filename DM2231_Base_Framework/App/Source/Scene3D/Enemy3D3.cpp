 ...
 */
CEnemy3D3::CEnemy3D3(	const glm::vec3 vec3Position,
...
bool CEnemy3D3::Init(void)
{
	...
	SetType2(CEntity3D::ENEMYTYPE::SCRAKE);
 ...
 */
void CEnemy3D3::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CEnemy3D3::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CEnemy3D3::SetProjection(glm::mat4 projection)
{
 ...
 */
void CEnemy3D3::AttachCamera(CCamera* cCamera)
{
 ...
 */
bool CEnemy3D3::IsCameraAttached(void)
{
	if (cCamera)
		return true;
	return false;
 ...
 */
void CEnemy3D3::ProcessMovement(const Enemy_Movement direction, const float deltaTime)
{
	float velocity = fMovementSpeed * deltaTime * 0.6f;
 ...
 */
void CEnemy3D3::ProcessRotate(const float fXOffset)
{
	// Update the yaw
...
*/
void CEnemy3D3::Update(const double dElapsedTime)
{
...
*/
void CEnemy3D3::ActivateCollider(Shader* cLineShader)
{
...
*/
void CEnemy3D3::PostRender(void)
{
 ...
 */
void CEnemy3D3::UpdateEnemyVectors(void)
{
