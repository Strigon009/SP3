...
*/
CAntidoteProjectile::CAntidoteProjectile(void)
	: bStatus(false)
	, dLifetime(0.0f)
	, fSpeed(1.0f)
	, pSource(NULL)
 ...
 */
bool CAntidoteProjectile::Init(	glm::vec3 vec3Position,
						glm::vec3 vec3Front,
						...
						const float fSpeed)
{
	...
	if (!cShader)
	{
		cout << "CAntidoteProjectile::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::ANTIDOTE);
 ...
 */
void CAntidoteProjectile::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CAntidoteProjectile::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CAntidoteProjectile::SetProjection(glm::mat4 projection)
{
...
*/
void CAntidoteProjectile::ActivateCollider(Shader* cLineShader)
{
 ...
 */
void CAntidoteProjectile::SetStatus(const bool bStatus)
{
	if (bStatus == false)
		dLifetime = 0.0f;
...
/** 
 ...
 @param vec3Front A const glm::vec3 variable which contains the up direction of the projectile
 */
void CAntidoteProjectile::SetDirection(glm::vec3 vec3Front)
{
	this->vec3Front = vec3Front;
}
...
/** 
 ...
 @param dLifetime A const float variable which contains the lifetime for this projectile
 */
void CAntidoteProjectile::SetLifetime(const double dLifetime)
{
	this->dLifetime = dLifetime;
}
...
/** 
 ...
 @param fSpeed A const float variable which contains the speed of the projectile
 */
void CAntidoteProjectile::SetSpeed(const float fSpeed)
{
	this->fSpeed = fSpeed;
}
 ...
 */
void CAntidoteProjectile::SetSource(CEntity3D* pSource)
{
 ...
 */
bool CAntidoteProjectile::GetStatus(void) const
{
	return bStatus;
}
 ...
 */
glm::vec3 CAntidoteProjectile::GetDirection(void)
{
	return vec3Front;
}
 ...
 */
double CAntidoteProjectile::GetLifetime(void) const
{
	return dLifetime;
}
 ...
 */
float CAntidoteProjectile::GetSpeed(void) const
{
	return fSpeed;
}
 ...
 */
CEntity3D* CAntidoteProjectile::GetSource(void) const
{
	return pSource;
}
 ...
 */
void CAntidoteProjectile::Update(const double dElapsedTime)
{
	if (bStatus == false)
		return;
...
*/
void CAntidoteProjectile::PreRender(void)
{
	// Draw this as last
 ...
 */
void CAntidoteProjectile::Render(void)
{
	if (bStatus == false)
		return;
	...
	if (!cShader)
	{
		cout << "CAntidoteProjectile::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CAntidoteProjectile::PostRender(void)
{
