 ...
 */
CMagazineAttachment::CMagazineAttachment(void)
	: cGroundMap(NULL)
	, cPlayer3D(NULL)
{
 ...
 */
CMagazineAttachment::CMagazineAttachment(const glm::vec3 vec3Position,
 ...
 */
bool CMagazineAttachment::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CMagazineAttachment::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::MAGAZINE_PICKUP);
	...
	vec3ColliderScale = glm::vec3(1, 1.5f, 1);

	std::string file_path = "OBJ/Magazine.obj";
	...
	iTextureID = LoadTexture("Image/Magazine.tga");
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/Magazine.tga" << endl; // Change file
		return false;
	}
 ...
 */
void CMagazineAttachment::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CMagazineAttachment::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CMagazineAttachment::SetProjection(glm::mat4 projection)
{
...
*/
void CMagazineAttachment::Update(const double dElapsedTime)
{
...
*/
void CMagazineAttachment::ActivateCollider(Shader* cLineShader)
{
...
*/
void CMagazineAttachment::PreRender(void)
{
	// Draw this as last
...
*/
void CMagazineAttachment::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CMagazineAttachment::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CMagazineAttachment::PostRender(void)
{
