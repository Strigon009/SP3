 ...
 */
CBarrelAttachment::CBarrelAttachment(void)
	: cGroundMap(NULL)
	, cPlayer3D(NULL)
{
 ...
 */
CBarrelAttachment::CBarrelAttachment(const glm::vec3 vec3Position,
 ...
 */
bool CBarrelAttachment::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CBarrelAttachment::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
	...
	// Set the type
	SetType(CEntity3D::TYPE::BARREL_PICKUP);
	...
	std::string file_path = "OBJ/Barrel.obj";
 ...
 */
void CBarrelAttachment::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CBarrelAttachment::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CBarrelAttachment::SetProjection(glm::mat4 projection)
{
...
*/
void CBarrelAttachment::Update(const double dElapsedTime)
{
...
*/
void CBarrelAttachment::ActivateCollider(Shader* cLineShader)
{
...
*/
void CBarrelAttachment::PreRender(void)
{
	// Draw this as last
...
*/
void CBarrelAttachment::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CBarrelAttachment::Render(): The shader is not available for this class instance." << endl;
		return;
	}
...
*/
void CBarrelAttachment::PostRender(void)
{
