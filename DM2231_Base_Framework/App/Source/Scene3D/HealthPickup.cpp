 ...
 */
CHealthPickup::CHealthPickup(const glm::vec3 vec3Position,
 ...
 */
bool CHealthPickup::Init(void)
{
	// Check if the shader is ready
	if (!cShader)
	{
		cout << "CHealthPickup::Init(): The shader is not available for this class instance." << endl;
		return false;
	}
 ...
 */
void CHealthPickup::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CHealthPickup::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CHealthPickup::SetProjection(glm::mat4 projection)
{
...
*/
void CHealthPickup::Update(const double dElapsedTime)
{
...
*/
void CHealthPickup::ActivateCollider(Shader* cLineShader)
{
...
*/
void CHealthPickup::PreRender(void)
{
	// Draw this as last
...
*/
void CHealthPickup::Render(void)
{
	// If the shader is in this class, then do not render
	if (!cShader)
	{
		cout << "CHealthPickup::Render(): The shader is not available for this class instance." << endl;
		return;
	}
